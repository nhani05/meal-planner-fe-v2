...
export default function LandingFooter() {
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { label: 'API Reference', path: '/docs/API.md' },
    ],
    legal: [
  ...
  return (
    <footer className="bg-[#171d16] text-white">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#4caf50] to-[#006e1c] flex items-center justify-center">
                <Leaf size={20} className="text-white" />
              </div>
              <div>
                <span className="font-black text-white text-xl tracking-tighter">
                  Nutri<span className="text-[#4caf50]">Plan</span>
                </span>
              </div>
            </Link>
            ...
            <div className="space-y-3">
              <a href="mailto:hello@nutriplan.com" className="flex items-center gap-2 text-sm text-[#a0a8a0] hover:text-[#4caf50] transition-colors">
                <Mail size={16} />
                hello@nutriplan.com
              </a>
              <a href="tel:+1234567890" className="flex items-center gap-2 text-sm text-[#a0a8a0] hover:text-[#4caf50] transition-colors">
                <Phone size={16} />
                +1 (234) 567-890
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {footerLinks.product.map((link) => (
                <li key={link.label}>
                  <Link to={link.path} className="text-sm text-[#a0a8a0] hover:text-[#4caf50] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                key={social.label}
                href={social.href}
                className="w-9 h-9 rounded-lg bg-[#2c322a] flex items-center justify-center text-[#a0a8a0] hover:bg-[#4caf50] hover:text-white transition-all"
